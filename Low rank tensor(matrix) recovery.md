...
- [Xiph.org test data](https://media.xiph.org/video/derf/)

# Grayscale Images

- [Brodatz texture images](https://www.ux.uis.no/~tranden/brodatz.html)

# Color Images

- [McMaster Database](http://www4.comp.polyu.edu.hk/~cslzhang/CDM_Dataset.htm)

- [MIT Vision Texture Database](https://vismod.media.mit.edu/vismod/imagery/VisionTexture/vistex.html)

- [Caltech256 Database](http://www.vision.caltech.edu/Image_Datasets/Caltech256/)
  
- [Columbia University Image Library (COIL-100)](https://www1.cs.columbia.edu/CAVE//software/softlib/coil-100.php)

- [McGill Calibrated Colour Image Database](http://tabby.vision.mcgill.ca/)

- [PSU Near-Regular Texture Database](http://vivid.cse.psu.edu/)
  
- [Urban](https://github.com/jbhuang0604/SelfExSR)

- [Places](http://places2.csail.mit.edu/download.html)

# Grayscale/Color Images

- [USC SIPI Image Databases](https://sipi.usc.edu/database/)

## [Hyper-Spectral Video (HSV)](http://openremotesensing.net/kb/data/)

# Traffic data

- [GTL](http://gtl.inrialpes.fr/status)
...
- [Columbia University Image Library (COIL-20 Data)](https://cave.cs.columbia.edu/repository/COIL-20)
